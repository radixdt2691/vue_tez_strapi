...
<nav>
  <div class=" flex flex-wrap justify-between items-center">
   <tez-link to="/discover-india" title="Discover India" class="flex items-center font-bold text-2xl">Discover India</tez-link>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="flex flex-col p-4 mt-4 bg-gray-50 border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
        <li class="!ml-0">
          <tez-link to="/" title="Home" class="block md:inline-block my-1 text-sm leading-5 text-gray-900 transition-colors duration-200 transform hover:text-indigo-600 md:mx-4 md:my-0 no-underline">Home</tez-link>
        </li>
        <li class="!ml-0">
         <tez-link
